...
public record CharacterClass(Component name, List<Component> description, AttributeList attributes,
                             AbilityTree mainAbilityTree, Map<ResourceLocation, Subclass> subclasses,
                             List<ResourceLocation> possibleRaceIds, ModelProperties modelProperties)
    ...
    public ResourceLocation getId() {
        return MythboundCore.CLASSES.getKeyOrThrow(this);
    }
